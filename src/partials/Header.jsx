      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="shrink-0 mr-4">
            {/* Logo */}
            {/* <Link className="block group" to="http://aureliengremy.com" aria-label="Portfolio"> */}
              {/* <svg width="30" height="30" xmlns="http://aureliengremy.com">
                <path
          ...
          {/* <nav className="flex grow"> */}
            ...
            {/* <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link className="font-cabinet-grotesk text-sm font-bold text-white underline hover:no-underline flex items-center" to="/signin">
                  Sign in
                </Link>
              </li>
              <li className="ml-6">
                <Link className="btn-sm inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group" to="/schedule-call">
                  Schedule A Call
