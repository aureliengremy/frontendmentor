...
import Illustration from '../assets/images/cta-illustration.svg';

function Cta({path, btnText, title}) {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 pointer-events-none -z-10" aria-hidden="true">
        <img className="max-w-none" src={Illustration} width="1440" height="242" />
      </div>

      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="h2 font-cabinet-grotesk text-white mb-6" data-aos="fade-up">
              {title ? title : "Retour sur la page d'acceuil."}
            </h2>
            <div data-aos="fade-up" data-aos-delay="100">
            <Link className="btn inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group" to={`${path}`}>
                {btnText ? btnText : "Accueil"}
